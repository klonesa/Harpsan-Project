...
@endlangrtl
<link rel="stylesheet" type="text/css" href="//www.fontstatic.com/f=Consolas" />
<style>
...
<!-- preloader -->
<div id="preloader">
<div id="spinner" style="position: absolute;left: 45%;top: 50%; right:auto; z-index: 1000;height: 31px;width: 31px;">
    <div class="preloader-fountainTextG">
        <div id="fountainTextG_1" class="fountainTextG">H</div>
        ...
        <div id="fountainTextG_7" class="fountainTextG">A</div>
