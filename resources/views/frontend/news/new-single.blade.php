                            ...
                            <div class="entry-header">
                                <div class="post-thumb">
                                    <div class="owl-carousel-1col">
                                        ...
                                        <div class="item">
                                            <img class="img-responsive"
                                                src="{{asset('uploads/posts/')}}/{{ $image->post_image_path}}"
                                                alt="{{ $post->title}}">
                                        </div>
                                        @endforeach
                                    </div>
                                ...
                                <div class="entry-meta media no-bg no-border mt-15 pb-20">
                                    ...
                                    <div class="media-body pl-15">
                                        <div class="new-content pull-left flip">
                                            ...
                                            <span
                                                class="mb-10 text-gray-darkgray mr-10 font-13">{{ trans('frontend.unit_type') }}
                                                :
                                    ...
                                    <ul class="styled-icons icon-circled m-0">
                                        ...
                                        <li>
                                            ...
                                            <div class="styled-icons icon-dark icon-theme-colored icon-sm icon-circled">
                                                ...
                                                <a
                                                    href="mailto:?Subject={{ $post->title }}&amp;Body={{url()->current()}}">
