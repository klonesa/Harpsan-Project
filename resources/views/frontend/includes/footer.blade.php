        ...
        <div class="row border-bottom-black">
            <div class="col-sm-12 col-md-12">
                <div  style="text-align: center;" class="widget">
                    <img width="300" height="300" class="mt-10 mb-20" alt="{{ GeneralSiteSettings('site_title')}}" src="{{asset('uploads/settings/')}}/harp-san-logo.png">
                <p>{{ GeneralSiteSettings('site_meta_description') }}</p>
                 <p>{{ GeneralSiteSettings('site_address')}}</p>
                    <ul class="list-inline mt-5">
                      
                    <li class="m-0 pl-10 pr-10"> <i class="fa fa-mobile text-theme-colored mr-5 float-left"></i> <a 
...
<div style="text-align: center;" class="col-md-4">
 ...
 {{ trans('frontend.Developedby:') }}
    <a  href="https://www.themedyacreative.com" target="_blank"  title="Themedya Creative" ><img style="width:80px;height:20px;text-align: center;"   alt="themedyacreative.com" data-no-retina="dsa">
     </a>
        </div>
