            ...
            <div class="col-md-12">
                <div class="divider call-to-action sm-text-center pt-10 pb-30">
                    <div class="col-md-7">
                        ...
                        <a class="btn btn-default btn-flat mt-10 mb-5"
                            href="{{ route('frontend.event',$event->slug)}}">{{ trans('frontend.read_more') }}</a>
                    </div>
                    <div class="col-md-5">
                        <div class="text-center text-white font-13 pt-30 mt-5"
                            data-countdown="{{ date('Y/m/d',strtotime($event->start_date)) }}"></div>
                            ...
                            $('[data-countdown]').each(function() {
                                ...
                                $this.countdown(finalDate, function(event) {
                                    $this.html(event.strftime(
                                        '<ul class="list-inline home-countdown"><li><span>%D</span><br> {{ trans('
                                        frontend
                                        .days ') }}</li><li><span>%H</span><br> {{ trans('
                                        frontend
                                        .hour ') }}</li><li><span>%M</span><br>{{ trans('
                                        frontend
                                        .minites ') }} </li><li><span>%S</span><br> {{ trans('
                                        frontend.seconds ') }} </li></ul>'));
                                });
                            });
                        });
                        </script>
            ...
            <div class="row">
                <div style="text-align:center;">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 pb-sm-20">
                        ...
                        <div
                            style="text-align: center;background-image: url({{asset('uploads/settings')}}/{{GeneralSiteSettings("site_logo")}}); background-repeat: no-repeat; background-position: center;background-size: contain;">
                        </div>
                        <div class="image-box-details pt-20 pb-sm-20">
                            <p style="text-align: justify;" class="lead mb-15">{!! $about->about_text !!}</p>
                            <a href="{{route('frontend.about')}}"
                                class="btn btn-sm btn-theme-colored mt-10">{{ trans('frontend.read_more') }}</a>
                        </div>
                    </div>
...
<div class="row">
    @foreach ($advertisementleft as $adverl)
    <div class="col-3" style="text-align:center;">

        <img src="{{asset('uploads/advertisement/')}}./{{$adverl->f_image}}" style="width: 900px; height: 100px;">
        ...
        <div class="section-title text-center">
            <div class="row">
                ...
                <div class="col-md-10 col-md-offset-1">
                    <h2 class="text-uppercase line-bottom-center mt-0">Duyurular</h2>
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="text-center">
                    ...
                    <div class="col-3" style="text-align:center;">
                        ...
                        <img src="{{asset('uploads/advertisement/')}}./{{$adver->f_image}}">
                                ...
                                <article class="post clearfix mb-sm-30 bg-silver-light">
                                    <div class="entry-header">
                                        <div class="post-thumb thumb">
                                            <a href="{{route('frontend.announcements',$aaa->slug)}}"><img
                                                    src="{{asset('uploads/announcements/')}}/{{ $aaa->f_image}}"
                                                    alt="{{$aaa->title}}" style="
    width: 200px;
      height: 200px;
" class="img-responsive img-fullwidth"></a>
                                    ...
                                    <div class="entry-content p-20 pr-10">
                                            ...
                                            <div
                                                ...
                                                <ul>
                                                    <li class="font-16 text-white font-weight-600 border-bottom">
                                                        {{ date('d',strtotime($aaa->date)) }}</li>
                                                    <li class="font-12 text-white text-uppercase">
                                                        {{ date('M',strtotime($aaa->date)) }}</li>
                                                </ul>
                                            </div>
                                            <div class="media-body pl-15">
                                                <div class="event-content pull-left flip">
                                                    <a href="{{route('frontend.new',$aaa->slug)}}">
                                                        <h4 class="entry-title text-black text-uppercase m-0 mt-5">
                                                            {{$aaa->title}}
                                                        </h4>
                                                    </a>
                                                </div>
                                        ...
                                        <p style="text-align: justify;" class="mt-10">{!!
                                            Str::words($aaa->text,20,'...')
                                            !!}</p>

                                        <a style="padding-right: 42px;"
                                            href="{{route('frontend.announcements',$aaa->slug)}}"
                                            class="btn btn-default btn-sm btn-theme-colored mt-10">{{ trans('frontend.read_more') }}</a>
                                    </div>
                                </article>
                            </div>
                            @endforeach
                        ...
                        <div class="separator">
                            <a href="{{route('frontend.announcements')}}">
                                <span>{{ trans('frontend.view_all') }}</span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-2">
                <div class="text-center">
                @foreach ($advertisementright as $adverr)
                    <div class="col-3" style="text-align:center;">

                        <img src="{{asset('uploads/advertisement/')}}./{{$adverr->f_image}}">
            ...
            <div class="row">
                                ...
                                <div
                                    ...
                                    <ul>
                                        <li class="font-28 text-white font-weight-700">
                                            {{ date('d',strtotime($event->start_date)) }}</li>
                                        <li class="font-18 text-white text-center text-uppercase">
                                            {{ date('M',strtotime($event->start_date)) }}</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xs-9 pr-10 pl-10">
                                <div class="event-content mt-10 p-5 pb-0 pt-0">
                                    <h5 class="media-heading font-16 font-weight-600"><a
                                            href="{{ route('frontend.event',$event->slug)}}">{{ $event->name }}</a></h5>
                                    <ul class="list-inline font-weight-600 text-gray-dimgray">
                                        <li><i
                                                class="fa fa-clock-o text-theme-colored"></i>{{date('d/m/Y - H:i',strtotime($event->start_date)) }}
                                            - {{ date('d/m/Y - H:i',strtotime($event->end_date)) }}</li>
                                        <li> <i class="fa fa-map-marker text-theme-colored"></i> {{ $event->location }}
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-md-6 col-sm-12">
                    <h3 class="text-uppercase title line-bottom mt-0 mb-30"><i
                            class="fa fa-thumb-tack text-theme-colored mr-10"></i>{{ trans('frontend.bylaws') }}</h3>
                    ...
                    <div class="event-content pull-left flip">
                        ...
                        <a class="btn btn-gray mt-10" href="{{asset('uploads/static')}}/{{$bylaws->g_pdf}}"><i
                                class="fa fa-file-pdf-o pr-5"></i> {{ trans('frontend.download') }} :
                            {{ $bylaws->g_title }} </a>
                    </div>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="owl-carousel-1col owl-dots-bottom-right">
                        ...
                        <div class="causes">
                            <div class="row-fluid">
                                <div class="col-md-5">
                                    <img src="{{asset('uploads/activities/')}}/{{ $activity->f_image }}"
                                        alt="{{ $activity->title }}">
                                </div>
                                <div class="col-md-7">
                                    <a href="{{route('frontend.activity',$activity->slug)}}">
                                        <h2 class="line-bottom mt-0">{{  $activity->title}}</h2>
                                    </a>
                                    <p>{!! Str::words($activity->text,30,'...') !!}</p>

                                    <div class="mt-10 mb-20">
                                        <ul class="list-inline clearfix mt-10">
                                            <li class="pull-left flip pr-0">{{ trans('frontend.activity_uint') }}: <span
                                                    class="font-weight-700 font-">
                                            ...
                                            <li class="text-theme-colored pull-right flip pr-0">
                                                {{ trans('frontend.activity_type') }}: <span class="font-weight-700">
                                    ...
                                    <a class="btn btn-theme-colored btn-sm"
                                        href="{{route('frontend.activity',$activity->slug)}}">{{ trans('frontend.read_more') }}</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <article class="post clearfix mb-sm-30 bg-silver-light">
                        <div class="entry-header">
                            <div class="post-thumb thumb">
                                <a href="{{route('frontend.new',$post->slug)}}"><img
                                        src="{{asset('uploads/posts/')}}/{{ $post->f_image}}" alt="{{$post->title}}"
                                        style="
                  width: 200px;
                  height: 200px;
              " class="img-responsive img-fullwidth"></a>
                        ...
                        <div class="entry-content p-20 pr-10">
                                ...
                                <div class="media-body pl-15">
                                    <div class="event-content pull-left flip">
                                        <a href="{{route('frontend.new',$post->slug)}}">
                                            <h4 class="entry-title text-black text-uppercase m-0 mt-5">{{$post->title}}
                                            </h4>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <a style="padding-right: 42px;" href="{{route('frontend.new',$post->slug)}}"
                                class="btn btn-default btn-sm btn-theme-colored mt-10">{{ trans('frontend.read_more') }}</a>
                        </div>
                    </article>
                </div>
