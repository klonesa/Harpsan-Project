            ...
            <div class="section-content text-center">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 text-center">
                        <h2 class="text-theme-colored font-36">Kurucu Üyeler</h2>



                               <!--  <div class="col-md-12">
                                    <div class="row">
                                         <form action="{{route('frontend.founding_members')}}" method="get">
                                        <!-- category dropdown 
                                        <div class="col-sm-3 col-md-4">
                                            <select class="form-control" name="sector">
                                           <option selected disabled>{{ trans('frontend.sort_by:_sector') }}</option>
                                                @foreach ($founding_members as $sector)
                                        ...
                                        <div class="col-sm-3 col-md-4">
                                            <select class="form-control"  name="field">
                                               ...
                                               @foreach ($founding_members as $field)
                   ...
                   @foreach ($founding_members as $member)
                    ...
                    <div class="col-sm-6 col-md-3 mb-30">
                        <div style="width: 100%;" class="team box-hover-effect effect3 border-1px border-bottom-theme-color-2px sm-text-center  ">
                            <div class="thumb">
                            <a class="text-theme-colored" > <img style="max-height: 280px;" class="img-fullwidth" src="{{asset('uploads/teams')}}/{{$member->image}}" alt="{{ $member->name_tr}}"></a></div>
                            <div class="content p-20 text-center">
                                <h4 class="name mb-0 mt-0"><a class="text-theme-colored" >{{ $member->name_tr}}</a></h4>
 
                                   
                                <!-- <p>{{ $member->company_name}}</p> -->
                                <p>{{ $member->position_tr}}</p>
                                <p>{{ $member->e_mail}}</p>
                                <p>{!! $member->text_tr !!}</p>
