                                    ...
                                    <tr>
                                      ...
                                      {{$adver->category}}
                                        ...
                                        <td>
                                            ...
                                            <a href=""
                                                onclick="if(confirm('Are You sure you want to delete this')){event.preventDefault();document.getElementById('delete-form-{{ $adver->id }}').submit();}else{event.preventDefault();}">
