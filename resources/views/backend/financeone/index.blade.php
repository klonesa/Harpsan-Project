            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{   route('admin.financeone.create')   }}" class="btn btn-primary mb-2"><i
                            ...
                            <table class="table add-rows">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           <a href="{{   route('admin.financeone.edit',$ad->id) }}"> <i
                                            ...
                                            <form id="delete-form-{{ $ad->id }}" method="post"
                                                action="{{ route('admin.financeone.destroy',$ad->id) }}">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
                                            </form>
